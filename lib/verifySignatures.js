...
var _ = require("lodash"),
	...
	derToPem = require("./derToPem"),
	xmlBuilder = new (require("xml2js").Builder)(),
	SignedXml = require("xml-crypto").SignedXml;

SignedXml.CanonicalizationAlgorithms['http://www.w3.org/TR/2001/REC-xml-c14n-20010315'] = require("xml-crypto/lib/exclusive-canonicalization").ExclusiveCanonicalization;
...
function verifySignatures(zip) {
	return Promise.resolve(zip.entries)
		...
		.then(function (res) {
			var entries = res[0], signaturesXml = res[1].xml; // @todo: can't wait for destructuring!
			...
			// @todo: return certificate as part of callback
